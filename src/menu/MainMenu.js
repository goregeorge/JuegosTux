...
TuxGame.MainMenu.prototype = {
  create: function(){
    ...
    game1block1 = this.add.button(140, 160, 'level-main-menu2', this.goGame1Block1, this, 1, 0, 2);
    game1block1.scale.setTo(0.4, 0.4);
    this.add.text(190, 180, "Juego 1", this._fontStyle2);

    game2block1 = this.add.button(420, 160, 'level-main-menu2', this.goGame2Block1, this, 1, 0, 2);
    ...
    game1block3 = this.add.button(140, 500, 'level-main-menu2', this.goGame1Block3, this, 1, 0, 2);
    game1block3.scale.setTo(0.4, 0.4);
    this.add.text(190, 520, "Juego 1", this._fontStyle2);

    game2block3 = this.add.button(420, 500, 'level-main-menu2', this.goGame2Block3, this, 1, 0, 2);
