TuxGame.Block3Game2_Q3 = function(game){
	...
	this._boats = [
		['b-t-1/9', 'b-t-1/3', 'b-t-4/6'],
		['b-c-5/6', 'b-c-3/6', 'b-c-1/1'],
		['b-s-4/8', 'b-s-3/8', 'b-s-2/8']
	];
	...
	this._audios = ['q3o1', 'q3o2', 'q3o3'];
	this._audio = null;

	this._questions = ['0/4 + 1/3', '5/6 + 2/4 - 1/2', '1/8 + 2/2 +1/4 - 1'];
};
