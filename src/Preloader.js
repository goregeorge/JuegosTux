...
TuxGame.Preloader.prototype = {
  preload: function(){
    ...
    ***************************************/
    ...
    this.load.image('number1', 'img/block2/game1/number_1.jpg');
    this.load.image('number2', 'img/block2/game1/number_2.jpg');
    this.load.image('number3', 'img/block2/game1/number_3.jpg');
    this.load.image('number4', 'img/block2/game1/number_4.jpg');
    this.load.image('number5', 'img/block2/game1/number_5.jpg');
    this.load.image('number6', 'img/block2/game1/number_6.jpg');
    this.load.image('number7', 'img/block2/game1/number_7.jpg');
    this.load.image('number8', 'img/block2/game1/number_8.jpg');
    this.load.image('number9', 'img/block2/game1/number_9.jpg');
