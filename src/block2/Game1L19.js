...
TuxGame.Block2Game1L19.prototype = {
  create: function(){
    ...
    levelText = this.add.text(50, 10, "Nivel 11", this._fontStyle2);
    ...
    this.randomResult = this.twoFloatsDiffOperationInRange(4,9);
  ...
  timeOver : function () {
    ...
    that = this;
    setTimeout(function () {
      that.state.start('Block2Game1L19');
    }, 1200);
  },
  stopDrag: function(currentSprite, endSprite){
    if (!this.physics.arcade.overlap(currentSprite, endSprite, function() {
      ...
      var that = this;
      setTimeout(function () {
        that.state.start('Block2Game1L21');
      }, 1200);
    }
  },
