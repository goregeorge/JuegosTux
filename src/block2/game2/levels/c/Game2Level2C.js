TuxGame.Block2Game2L2C = function(game){
  // define needed variables for Candy.Game
  this.game = game;
};
TuxGame.Block2Game2L2C.prototype = {
  create: function(){
    currentColor = "green";
    colors = {
      white:  0,
    ...
    this.instructionText = this.add.text(200, 440, "Coloréa de amarillo 3/4 del \n rectángulo blanco pez ", this._fontStyle);
  ...
  verifyAnswer : function (btn) {
    ...
    if (colors['yellow'] != 3) {
      ...
      var that = this;
      setTimeout(function () {
        that.state.start('Block2Game2L3C');
      }, 1200);
    }
  }
