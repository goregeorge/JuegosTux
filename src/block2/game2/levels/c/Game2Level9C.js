TuxGame.Block2Game2L9C = function(game){
  // define needed variables for Candy.Game
  this.game = game;
};
TuxGame.Block2Game2L9C.prototype = {
  create: function(){
    currentColor = "green";
    colors = {
      green:  0,
  ...
  verifyAnswer : function (btn) {
    if (!(colors['pink'] == 5 && colors['purple'] == 4 && colors['red'] == 7)) {
      TuxGame._incorrect += 1;
      ...
      var that = this;
      setTimeout(function () {
        that.state.start('Block2Game2L10C');
      }, 1200);
    }
  }
