TuxGame.Block2Game2L4C = function(game){
  // define needed variables for Candy.Game
  this.game = game;
};
TuxGame.Block2Game2L4C.prototype = {
  create: function(){
    currentColor = "green";
    colors = {
      green:  0,
    ...
    this.instructionText = this.add.text(200, 440, "Coloréa de verde 5/8 del \n rectángulo blanco del pez ", this._fontStyle);
  ...
  verifyAnswer : function (btn) {
    if (colors['green'] != 5) {
      ...
      var that = this;
      setTimeout(function () {
        that.state.start('Block2Game2L5C');
      }, 1200);
    }
  }
