TuxGame.Block2Game2L3C = function(game){
  // define needed variables for Candy.Game
  this.game = game;
};
TuxGame.Block2Game2L3C.prototype = {
  create: function(){
    currentColor = "green";
    colors = {
      white:  0,
    ...
    this.instructionText = this.add.text(200, 440, "Coloréa de naranja 3/6 del \n rectángulo blanco del pez ", this._fontStyle);
  ...
  verifyAnswer : function (btn) {
    if (colors['orange'] != 3) {
      ...
      var that = this;
      setTimeout(function () {
        that.state.start('Block2Game2L4C');
      }, 1200);
    }
  }
