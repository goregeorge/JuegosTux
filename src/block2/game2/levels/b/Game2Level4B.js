TuxGame.Block2Game2L4B = function(game){
  // define needed variables for Candy.Game
  this.game = game;
};
TuxGame.Block2Game2L4B.prototype = {
  create: function(){
    currentColor = "green";
    colors = {
      green:  0,
    ...
    this.instructionText = this.add.text(200, 440, "Coloréa de morado 6/8 del \n rectángulo blanco del pez ", this._fontStyle);
  ...
  verifyAnswer : function (btn) {
    if (colors['purple'] != 6) {
      ...
      var that = this;
      setTimeout(function () {
        that.state.start('Block2Game2L5B');
      }, 1200);
    }
  }
