TuxGame.Block2Game2L1B = function(game){
  // define needed variables for Candy.Game
  this.game = game;
};
TuxGame.Block2Game2L1B.prototype = {
  create: function(){
    ...
    this.instructionText = this.add.text(200, 440, "Coloréa de rosa 1/2 del \n rectángulo blanco del pez ", this._fontStyle);
  ...
  verifyAnswer : function (btn) {
    if (colors['pink'] != 1 && colors['white'] != 1) {
      ...
      var that = this;
      setTimeout(function () {
        that.state.start('Block2Game2L2B');
      }, 1200);
    }
  }
};
