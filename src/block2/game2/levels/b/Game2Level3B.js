TuxGame.Block2Game2L3B = function(game){
  // define needed variables for Candy.Game
  this.game = game;
};
TuxGame.Block2Game2L3B.prototype = {
  create: function(){
    currentColor = "green";
    colors = {
      white:  0,
    ...
    this.instructionText = this.add.text(200, 440, "Coloréa de rojo 4/6 del \n rectángulo blanco del pez ", this._fontStyle);
  ...
  verifyAnswer : function (btn) {
    if (colors['red'] != 4) {
      ...
      var that = this;
      setTimeout(function () {
        that.state.start('Block2Game2L4B');
      }, 1200);
    }
  }
