TuxGame.Block2Game2L8B = function(game){
  // define needed variables for Candy.Game
  this.game = game;
};
TuxGame.Block2Game2L8B.prototype = {
  create: function(){
    currentColor = "green";
    colors = {
      green:  0,
  ...
  verifyAnswer : function (btn) {
    if (!(colors['red'] == 4 && colors['yellow'] == 4 && colors['orange'] == 4)) {
      TuxGame._incorrect += 1;
      ...
      var that = this;
      setTimeout(function () {
        that.state.start('Block2Game2L9B');
      }, 1200);
    }
  }
