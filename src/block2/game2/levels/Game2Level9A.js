TuxGame.Block2Game2L9A = function(game){
  // define needed variables for Candy.Game
  this.game = game;
};
TuxGame.Block2Game2L9A.prototype = {
  create: function(){
    currentColor = "green";
    colors = {
      green:  0,
  ...
  verifyAnswer : function (btn) {
    if (!(colors['purple'] == 5 && colors['yellow'] == 6 && colors['red'] == 5)) {
      TuxGame._incorrect += 1;
      ...
      var that = this;
      setTimeout(function () {
        that.state.start('Block2Game2L10A');
      }, 1200);
    }
  }
