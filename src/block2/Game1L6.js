TuxGame.Block2Game1L6 = function(game){
...
TuxGame.Block2Game1L6.prototype = {
  create: function(){
    ...
    this.randomResult = this.twoIntegersDifOperationInRange();
  ...
  timeOver : function () {
    ...
    that = this;
    setTimeout(function () {
      that.state.start('Block2Game1L6');
    }, 1200);
  },
  stopDrag: function(currentSprite, endSprite){
    if (!this.physics.arcade.overlap(currentSprite, endSprite, function() {
      ...
      var that = this;
      setTimeout(function () {
        that.state.start('Block2Game1L7');
      }, 1200);
    }
  },
